...
from business_performance_agent.tools.calculations import absolute_change, additive_contribution, closure_check, coverage, evaluate_formula, rank_effects, relative_change, symmetric_two_factor_decomposition
...
class CalculationTests(unittest.TestCase):
    ...
    def test_symmetric_closure(self):
        for a0,a1,b0,b1 in [(10,9,100,98),(0,2,3,4),(3,1,2,7),(-2,3,8,1)]:
    ...
    def test_offsets_ranking_coverage(self):
        values=rank_effects(-10,[{'id':'offset','effect':5},{'id':'driver','effect':-15}])
    ...
    def test_formula_rejects_execution(self):
        with self.assertRaises(ValueError): evaluate_formula("__import__('os')",lambda _:0)
